...
public class SudokuLayoutDark extends JFrame{
	...
	public static final Color DARK_PURPLE = new Color(110,53,141);
	public static final Color CLOSED_CELL_BGCOLOR = DARK_PURPLE;
	public static final Color CLOSED_CELL_TEXT =  Color.WHITE;
	...
	private final Border b1 = BorderFactory.createMatteBorder(0, 0, 2, 2, Color.WHITE);
	...
	private final Border b7 = BorderFactory.createCompoundBorder(
			      BorderFactory.createMatteBorder(2, 0, 0,2, Color.WHITE),
			      BorderFactory.createMatteBorder(0, 1,1, 0, Color.GRAY));
	private final Border b8 = BorderFactory.createCompoundBorder(
			      BorderFactory.createMatteBorder(0, 2, 2,0, Color.WHITE),
			      BorderFactory.createMatteBorder(0, 0,0, 1, Color.GRAY));
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SudokuLayoutDark frame = new SudokuLayoutDark();
	...
	public SudokuLayoutDark() {
		...
		//add drop down menu to set difficulty level
		...
		newGameBtn.setBackground(OPEN_CELL_BGCOLOR);
		...
		hintBtn.setBounds(700,200,100,50);
